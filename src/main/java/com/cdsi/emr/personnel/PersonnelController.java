...
public class PersonnelController {
	...
	public String editPersonnel(
		...
		Personnel fromDb = personnelRepository.findById(personnelDto.getId()).orElseGet(() -> new Personnel());
		Personnel fromDto = toPersonnel(personnelDto);
		...
		Authentication authentication = new UsernamePasswordAuthenticationToken(personnelRepository.save(fromDto),
				fromDb.getPassword(),
